        ...
        <nav className='w-full flex flex-wrap py-2 justify-between items-center navbar'>
            ...
            <div className='hidden sm:block mx-4 my-2'>
                <form action='#' className='flex items-center'>
                    <input className='pl-2 border-x border-y border-primary1 hover:border-primary2 rounded-l-full'></input>
            ...
            <div className='sm:hidden flex flex-1 justify-end items-center z-10'>
                ...
                <div className={`${toggle ? 'flex' : 'hidden'} p-6 bg-white drop-shadow-2xl absolute top-20 right-0 mx-4 my-2 min-w-[140px] rounded-lg sidebar`}>
